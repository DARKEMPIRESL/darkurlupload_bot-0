class Translation(object):
    ...
    NOYES_URL = "@GetPublicLinkBot URL tespit edildi. Lütfen servisi kötüye kullanma!"
    ...
    NO_VOID_FORMAT_FOUND = "URL’yi kontrol edebilir misiniz? URL’den video biçimini tespit edemiyorum. Eğer botta bir hata bulursanız buradan bildirebilirsiniz https://github.com/spechide/darkurlupload_bot/issues"
    USER_ADDED_TO_DB = "{} 'E kadar {}' a <a href='tg://user?id={|'> {} </a> kullanıcısı eklendi.
    CURENT_PLAN_DETAILS = """ Mevcut plan detayları
--------
Telegram ID: <code>{}</code>
Plan ismi: <a href='https://t.me/DARKEMPIRESL/599'>{}</a>
Bitiş tarihi: {}"""
...
/me komutunu kullanarak şuanki mevcut plan detaylarını görüntüle"""
    ...
    ABUSIVE_USERS = "Bu botu kullanmana izin verilmiyor. Bunun bir hata olduğunu düşünüyorsanız, buradan  <a href='https://telegram.dog/ShrimadhaVahdamirhS'>@DARKEMPIRESL</a> iletişime geçin ve bu engellemeyi kaldırın."
